...
var MeshGradient = (0, import_react.memo)(function MeshGradientImpl({ speed = defaultPreset$27.params.speed, frame = defaultPreset$27.params.frame, colors = defaultPreset$27.params.colors, distortion = defaultPreset$27.params.distortion, swirl = defaultPreset$27.params.swirl, grainMixer = defaultPreset$27.params.grainMixer, grainOverlay = defaultPreset$27.params.grainOverlay, fit = defaultPreset$27.params.fit, rotation = defaultPreset$27.params.rotation, scale = defaultPreset$27.params.scale, originX = defaultPreset$27.params.originX, originY = defaultPreset$27.params.originY, offsetX = defaultPreset$27.params.offsetX, offsetY = defaultPreset$27.params.offsetY, worldWidth = defaultPreset$27.params.worldWidth, worldHeight = defaultPreset$27.params.worldHeight, ...props }) {
	const uniforms = {
...
var SmokeRing = (0, import_react.memo)(function SmokeRingImpl({ speed = defaultPreset$26.params.speed, frame = defaultPreset$26.params.frame, colorBack = defaultPreset$26.params.colorBack, colors = defaultPreset$26.params.colors, noiseScale = defaultPreset$26.params.noiseScale, thickness = defaultPreset$26.params.thickness, radius = defaultPreset$26.params.radius, innerShape = defaultPreset$26.params.innerShape, noiseIterations = defaultPreset$26.params.noiseIterations, fit = defaultPreset$26.params.fit, scale = defaultPreset$26.params.scale, rotation = defaultPreset$26.params.rotation, originX = defaultPreset$26.params.originX, originY = defaultPreset$26.params.originY, offsetX = defaultPreset$26.params.offsetX, offsetY = defaultPreset$26.params.offsetY, worldWidth = defaultPreset$26.params.worldWidth, worldHeight = defaultPreset$26.params.worldHeight, ...props }) {
	const uniforms = {
...
var NeuroNoise = (0, import_react.memo)(function NeuroNoiseImpl({ speed = defaultPreset$25.params.speed, frame = defaultPreset$25.params.frame, colorFront = defaultPreset$25.params.colorFront, colorMid = defaultPreset$25.params.colorMid, colorBack = defaultPreset$25.params.colorBack, brightness = defaultPreset$25.params.brightness, contrast = defaultPreset$25.params.contrast, fit = defaultPreset$25.params.fit, scale = defaultPreset$25.params.scale, rotation = defaultPreset$25.params.rotation, originX = defaultPreset$25.params.originX, originY = defaultPreset$25.params.originY, offsetX = defaultPreset$25.params.offsetX, offsetY = defaultPreset$25.params.offsetY, worldWidth = defaultPreset$25.params.worldWidth, worldHeight = defaultPreset$25.params.worldHeight, ...props }) {
	const uniforms = {
...
var DotOrbit = (0, import_react.memo)(function DotOrbitImpl({ speed = defaultPreset$24.params.speed, frame = defaultPreset$24.params.frame, colorBack = defaultPreset$24.params.colorBack, colors = defaultPreset$24.params.colors, size = defaultPreset$24.params.size, sizeRange = defaultPreset$24.params.sizeRange, spreading = defaultPreset$24.params.spreading, stepsPerColor = defaultPreset$24.params.stepsPerColor, fit = defaultPreset$24.params.fit, scale = defaultPreset$24.params.scale, rotation = defaultPreset$24.params.rotation, originX = defaultPreset$24.params.originX, originY = defaultPreset$24.params.originY, offsetX = defaultPreset$24.params.offsetX, offsetY = defaultPreset$24.params.offsetY, worldWidth = defaultPreset$24.params.worldWidth, worldHeight = defaultPreset$24.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var DotGrid = (0, import_react.memo)(function DotGridImpl({ colorBack = defaultPreset$23.params.colorBack, colorFill = defaultPreset$23.params.colorFill, colorStroke = defaultPreset$23.params.colorStroke, size = defaultPreset$23.params.size, gapX = defaultPreset$23.params.gapX, gapY = defaultPreset$23.params.gapY, strokeWidth = defaultPreset$23.params.strokeWidth, sizeRange = defaultPreset$23.params.sizeRange, opacityRange = defaultPreset$23.params.opacityRange, shape = defaultPreset$23.params.shape, fit = defaultPreset$23.params.fit, scale = defaultPreset$23.params.scale, rotation = defaultPreset$23.params.rotation, originX = defaultPreset$23.params.originX, originY = defaultPreset$23.params.originY, offsetX = defaultPreset$23.params.offsetX, offsetY = defaultPreset$23.params.offsetY, worldWidth = defaultPreset$23.params.worldWidth, worldHeight = defaultPreset$23.params.worldHeight, maxPixelCount = 6016 * 3384, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
...
var SimplexNoise = (0, import_react.memo)(function SimplexNoiseImpl({ speed = defaultPreset$22.params.speed, frame = defaultPreset$22.params.frame, colors = defaultPreset$22.params.colors, stepsPerColor = defaultPreset$22.params.stepsPerColor, softness = defaultPreset$22.params.softness, fit = defaultPreset$22.params.fit, scale = defaultPreset$22.params.scale, rotation = defaultPreset$22.params.rotation, originX = defaultPreset$22.params.originX, originY = defaultPreset$22.params.originY, offsetX = defaultPreset$22.params.offsetX, offsetY = defaultPreset$22.params.offsetY, worldWidth = defaultPreset$22.params.worldWidth, worldHeight = defaultPreset$22.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_stepsPerColor: stepsPerColor,
...
var Metaballs = (0, import_react.memo)(function MetaballsImpl({ speed = defaultPreset$21.params.speed, frame = defaultPreset$21.params.frame, colorBack = defaultPreset$21.params.colorBack, colors = defaultPreset$21.params.colors, size = defaultPreset$21.params.size, count = defaultPreset$21.params.count, fit = defaultPreset$21.params.fit, rotation = defaultPreset$21.params.rotation, scale = defaultPreset$21.params.scale, originX = defaultPreset$21.params.originX, originY = defaultPreset$21.params.originY, offsetX = defaultPreset$21.params.offsetX, offsetY = defaultPreset$21.params.offsetY, worldWidth = defaultPreset$21.params.worldWidth, worldHeight = defaultPreset$21.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var Waves = (0, import_react.memo)(function WavesImpl({ colorFront = defaultPreset$20.params.colorFront, colorBack = defaultPreset$20.params.colorBack, shape = defaultPreset$20.params.shape, frequency = defaultPreset$20.params.frequency, amplitude = defaultPreset$20.params.amplitude, spacing = defaultPreset$20.params.spacing, proportion = defaultPreset$20.params.proportion, softness = defaultPreset$20.params.softness, fit = defaultPreset$20.params.fit, scale = defaultPreset$20.params.scale, rotation = defaultPreset$20.params.rotation, offsetX = defaultPreset$20.params.offsetX, offsetY = defaultPreset$20.params.offsetY, originX = defaultPreset$20.params.originX, originY = defaultPreset$20.params.originY, worldWidth = defaultPreset$20.params.worldWidth, worldHeight = defaultPreset$20.params.worldHeight, maxPixelCount = 6016 * 3384, ...props }) {
	const uniforms = {
		u_colorFront: getShaderColorFromString(colorFront),
		u_colorBack: getShaderColorFromString(colorBack),
		u_shape: shape,
...
var PerlinNoise = (0, import_react.memo)(function PerlinNoiseImpl({ speed = defaultPreset$19.params.speed, frame = defaultPreset$19.params.frame, colorFront = defaultPreset$19.params.colorFront, colorBack = defaultPreset$19.params.colorBack, proportion = defaultPreset$19.params.proportion, softness = defaultPreset$19.params.softness, octaveCount = defaultPreset$19.params.octaveCount, persistence = defaultPreset$19.params.persistence, lacunarity, fit = defaultPreset$19.params.fit, worldWidth = defaultPreset$19.params.worldWidth, worldHeight = defaultPreset$19.params.worldHeight, scale = defaultPreset$19.params.scale, rotation = defaultPreset$19.params.rotation, originX = defaultPreset$19.params.originX, originY = defaultPreset$19.params.originY, offsetX = defaultPreset$19.params.offsetX, offsetY = defaultPreset$19.params.offsetY, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorFront: getShaderColorFromString(colorFront),
		u_proportion: proportion,
		u_softness: softness ?? defaultPreset$19.params.softness,
		u_octaveCount: octaveCount ?? defaultPreset$19.params.octaveCount,
		u_persistence: persistence ?? defaultPreset$19.params.persistence,
		u_lacunarity: lacunarity ?? defaultPreset$19.params.lacunarity,
		u_fit: ShaderFitOptions[fit],
		u_scale: scale,
		u_rotation: rotation,
		u_offsetX: offsetX,
...
var Warp = (0, import_react.memo)(function WarpImpl({ speed = defaultPreset$17.params.speed, frame = defaultPreset$17.params.frame, colors = defaultPreset$17.params.colors, proportion = defaultPreset$17.params.proportion, softness = defaultPreset$17.params.softness, distortion = defaultPreset$17.params.distortion, swirl = defaultPreset$17.params.swirl, swirlIterations = defaultPreset$17.params.swirlIterations, shapeScale = defaultPreset$17.params.shapeScale, shape = defaultPreset$17.params.shape, fit = defaultPreset$17.params.fit, scale = defaultPreset$17.params.scale, rotation = defaultPreset$17.params.rotation, originX = defaultPreset$17.params.originX, originY = defaultPreset$17.params.originY, offsetX = defaultPreset$17.params.offsetX, offsetY = defaultPreset$17.params.offsetY, worldWidth = defaultPreset$17.params.worldWidth, worldHeight = defaultPreset$17.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_proportion: proportion,
...
var GodRays = (0, import_react.memo)(function GodRaysImpl({ speed = defaultPreset$16.params.speed, frame = defaultPreset$16.params.frame, colorBloom = defaultPreset$16.params.colorBloom, colorBack = defaultPreset$16.params.colorBack, colors = defaultPreset$16.params.colors, density = defaultPreset$16.params.density, spotty = defaultPreset$16.params.spotty, midIntensity = defaultPreset$16.params.midIntensity, midSize = defaultPreset$16.params.midSize, intensity = defaultPreset$16.params.intensity, bloom = defaultPreset$16.params.bloom, fit = defaultPreset$16.params.fit, scale = defaultPreset$16.params.scale, rotation = defaultPreset$16.params.rotation, originX = defaultPreset$16.params.originX, originY = defaultPreset$16.params.originY, offsetX = defaultPreset$16.params.offsetX, offsetY = defaultPreset$16.params.offsetY, worldWidth = defaultPreset$16.params.worldWidth, worldHeight = defaultPreset$16.params.worldHeight, ...props }) {
	const uniforms = {
...
var Spiral = (0, import_react.memo)(function SpiralImpl({ speed = defaultPreset$15.params.speed, frame = defaultPreset$15.params.frame, colorBack = defaultPreset$15.params.colorBack, colorFront = defaultPreset$15.params.colorFront, density = defaultPreset$15.params.density, distortion = defaultPreset$15.params.distortion, strokeWidth = defaultPreset$15.params.strokeWidth, strokeTaper = defaultPreset$15.params.strokeTaper, strokeCap = defaultPreset$15.params.strokeCap, noiseFrequency = defaultPreset$15.params.noiseFrequency, noise = defaultPreset$15.params.noise, softness = defaultPreset$15.params.softness, fit = defaultPreset$15.params.fit, rotation = defaultPreset$15.params.rotation, scale = defaultPreset$15.params.scale, originX = defaultPreset$15.params.originX, originY = defaultPreset$15.params.originY, offsetX = defaultPreset$15.params.offsetX, offsetY = defaultPreset$15.params.offsetY, worldWidth = defaultPreset$15.params.worldWidth, worldHeight = defaultPreset$15.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorFront: getShaderColorFromString(colorFront),
		u_density: density,
...
var Swirl = (0, import_react.memo)(function SwirlImpl({ speed = defaultPreset$14.params.speed, frame = defaultPreset$14.params.frame, colorBack = defaultPreset$14.params.colorBack, colors = defaultPreset$14.params.colors, bandCount = defaultPreset$14.params.bandCount, twist = defaultPreset$14.params.twist, center = defaultPreset$14.params.center, proportion = defaultPreset$14.params.proportion, softness = defaultPreset$14.params.softness, noiseFrequency = defaultPreset$14.params.noiseFrequency, noise = defaultPreset$14.params.noise, fit = defaultPreset$14.params.fit, rotation = defaultPreset$14.params.rotation, scale = defaultPreset$14.params.scale, originX = defaultPreset$14.params.originX, originY = defaultPreset$14.params.originY, offsetX = defaultPreset$14.params.offsetX, offsetY = defaultPreset$14.params.offsetY, worldWidth = defaultPreset$14.params.worldWidth, worldHeight = defaultPreset$14.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var Dithering = (0, import_react.memo)(function DitheringImpl({ speed = defaultPreset$13.params.speed, frame = defaultPreset$13.params.frame, colorBack = defaultPreset$13.params.colorBack, colorFront = defaultPreset$13.params.colorFront, shape = defaultPreset$13.params.shape, type = defaultPreset$13.params.type, pxSize, size = pxSize === void 0 ? defaultPreset$13.params.size : pxSize, fit = defaultPreset$13.params.fit, scale = defaultPreset$13.params.scale, rotation = defaultPreset$13.params.rotation, originX = defaultPreset$13.params.originX, originY = defaultPreset$13.params.originY, offsetX = defaultPreset$13.params.offsetX, offsetY = defaultPreset$13.params.offsetY, worldWidth = defaultPreset$13.params.worldWidth, worldHeight = defaultPreset$13.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorFront: getShaderColorFromString(colorFront),
...
var GrainGradient = (0, import_react.memo)(function GrainGradientImpl({ speed = defaultPreset$12.params.speed, frame = defaultPreset$12.params.frame, colorBack = defaultPreset$12.params.colorBack, colors = defaultPreset$12.params.colors, softness = defaultPreset$12.params.softness, intensity = defaultPreset$12.params.intensity, noise = defaultPreset$12.params.noise, shape = defaultPreset$12.params.shape, fit = defaultPreset$12.params.fit, scale = defaultPreset$12.params.scale, rotation = defaultPreset$12.params.rotation, originX = defaultPreset$12.params.originX, originY = defaultPreset$12.params.originY, offsetX = defaultPreset$12.params.offsetX, offsetY = defaultPreset$12.params.offsetY, worldWidth = defaultPreset$12.params.worldWidth, worldHeight = defaultPreset$12.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var PulsingBorder = (0, import_react.memo)(function PulsingBorderImpl({ speed = defaultPreset$11.params.speed, frame = defaultPreset$11.params.frame, colors = defaultPreset$11.params.colors, colorBack = defaultPreset$11.params.colorBack, roundness = defaultPreset$11.params.roundness, thickness = defaultPreset$11.params.thickness, aspectRatio = defaultPreset$11.params.aspectRatio, softness = defaultPreset$11.params.softness, bloom = defaultPreset$11.params.bloom, intensity = defaultPreset$11.params.intensity, spots = defaultPreset$11.params.spots, spotSize = defaultPreset$11.params.spotSize, pulse = defaultPreset$11.params.pulse, smoke = defaultPreset$11.params.smoke, smokeSize = defaultPreset$11.params.smokeSize, margin, marginLeft = margin ?? defaultPreset$11.params.marginLeft, marginRight = margin ?? defaultPreset$11.params.marginRight, marginTop = margin ?? defaultPreset$11.params.marginTop, marginBottom = margin ?? defaultPreset$11.params.marginBottom, fit = defaultPreset$11.params.fit, rotation = defaultPreset$11.params.rotation, scale = defaultPreset$11.params.scale, originX = defaultPreset$11.params.originX, originY = defaultPreset$11.params.originY, offsetX = defaultPreset$11.params.offsetX, offsetY = defaultPreset$11.params.offsetY, worldWidth = defaultPreset$11.params.worldWidth, worldHeight = defaultPreset$11.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var ColorPanels = (0, import_react.memo)(function ColorPanelsImpl({ speed = defaultPreset$10.params.speed, frame = defaultPreset$10.params.frame, colors = defaultPreset$10.params.colors, colorBack = defaultPreset$10.params.colorBack, angle1 = defaultPreset$10.params.angle1, angle2 = defaultPreset$10.params.angle2, length = defaultPreset$10.params.length, edges = defaultPreset$10.params.edges, blur = defaultPreset$10.params.blur, fadeIn = defaultPreset$10.params.fadeIn, fadeOut = defaultPreset$10.params.fadeOut, density = defaultPreset$10.params.density, gradient = defaultPreset$10.params.gradient, fit = defaultPreset$10.params.fit, scale = defaultPreset$10.params.scale, rotation = defaultPreset$10.params.rotation, originX = defaultPreset$10.params.originX, originY = defaultPreset$10.params.originY, offsetX = defaultPreset$10.params.offsetX, offsetY = defaultPreset$10.params.offsetY, worldWidth = defaultPreset$10.params.worldWidth, worldHeight = defaultPreset$10.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_colorBack: getShaderColorFromString(colorBack),
...
var StaticRadialGradient = (0, import_react.memo)(function StaticRadialGradientImpl({ speed = defaultPreset$8.params.speed, frame = defaultPreset$8.params.frame, colorBack = defaultPreset$8.params.colorBack, colors = defaultPreset$8.params.colors, radius = defaultPreset$8.params.radius, focalDistance = defaultPreset$8.params.focalDistance, focalAngle = defaultPreset$8.params.focalAngle, falloff = defaultPreset$8.params.falloff, grainMixer = defaultPreset$8.params.grainMixer, mixing = defaultPreset$8.params.mixing, distortion = defaultPreset$8.params.distortion, distortionShift = defaultPreset$8.params.distortionShift, distortionFreq = defaultPreset$8.params.distortionFreq, grainOverlay = defaultPreset$8.params.grainOverlay, fit = defaultPreset$8.params.fit, rotation = defaultPreset$8.params.rotation, scale = defaultPreset$8.params.scale, originX = defaultPreset$8.params.originX, originY = defaultPreset$8.params.originY, offsetX = defaultPreset$8.params.offsetX, offsetY = defaultPreset$8.params.offsetY, worldWidth = defaultPreset$8.params.worldWidth, worldHeight = defaultPreset$8.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var PaperTexture = (0, import_react.memo)(function PaperTextureImpl({ speed = defaultPreset$7.params.speed, frame = defaultPreset$7.params.frame, colorFront = defaultPreset$7.params.colorFront, colorBack = defaultPreset$7.params.colorBack, image = "", contrast = defaultPreset$7.params.contrast, roughness = defaultPreset$7.params.roughness, fiber = defaultPreset$7.params.fiber, crumples = defaultPreset$7.params.crumples, folds = defaultPreset$7.params.folds, drops = defaultPreset$7.params.drops, seed = defaultPreset$7.params.seed, fiberScale, fiberSize = fiberScale === void 0 ? defaultPreset$7.params.fiberSize : .2 / fiberScale, crumplesScale, crumpleSize = crumplesScale === void 0 ? defaultPreset$7.params.crumpleSize : .2 / crumplesScale, blur, fade = blur === void 0 ? defaultPreset$7.params.fade : blur, foldsNumber, foldCount = foldsNumber === void 0 ? defaultPreset$7.params.foldCount : foldsNumber, fit = defaultPreset$7.params.fit, scale = defaultPreset$7.params.scale, rotation = defaultPreset$7.params.rotation, originX = defaultPreset$7.params.originX, originY = defaultPreset$7.params.originY, offsetX = defaultPreset$7.params.offsetX, offsetY = defaultPreset$7.params.offsetY, worldWidth = defaultPreset$7.params.worldWidth, worldHeight = defaultPreset$7.params.worldHeight, ...props }) {
...
var FlutedGlass = (0, import_react.memo)(function FlutedGlassImpl({ speed = defaultPreset$6.params.speed, frame = defaultPreset$6.params.frame, colorBack = defaultPreset$6.params.colorBack, colorShadow = defaultPreset$6.params.colorShadow, colorHighlight = defaultPreset$6.params.colorHighlight, image = "", shadows = defaultPreset$6.params.shadows, angle = defaultPreset$6.params.angle, distortion = defaultPreset$6.params.distortion, distortionShape = defaultPreset$6.params.distortionShape, highlights = defaultPreset$6.params.highlights, shape = defaultPreset$6.params.shape, shift = defaultPreset$6.params.shift, blur = defaultPreset$6.params.blur, edges = defaultPreset$6.params.edges, margin, marginLeft = margin ?? defaultPreset$6.params.marginLeft, marginRight = margin ?? defaultPreset$6.params.marginRight, marginTop = margin ?? defaultPreset$6.params.marginTop, marginBottom = margin ?? defaultPreset$6.params.marginBottom, grainMixer = defaultPreset$6.params.grainMixer, grainOverlay = defaultPreset$6.params.grainOverlay, stretch = defaultPreset$6.params.stretch, count, size = count === void 0 ? defaultPreset$6.params.size : Math.pow(1 / (count * 1.6), 1 / 6) / .7 - .5, fit = defaultPreset$6.params.fit, scale = defaultPreset$6.params.scale, rotation = defaultPreset$6.params.rotation, originX = defaultPreset$6.params.originX, originY = defaultPreset$6.params.originY, offsetX = defaultPreset$6.params.offsetX, offsetY = defaultPreset$6.params.offsetY, worldWidth = defaultPreset$6.params.worldWidth, worldHeight = defaultPreset$6.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorBack: getShaderColorFromString(colorBack),
...
var Water = (0, import_react.memo)(function WaterImpl({ speed = defaultPreset$5.params.speed, frame = defaultPreset$5.params.frame, colorBack = defaultPreset$5.params.colorBack, colorHighlight = defaultPreset$5.params.colorHighlight, image = "", highlights = defaultPreset$5.params.highlights, layering = defaultPreset$5.params.layering, waves = defaultPreset$5.params.waves, edges = defaultPreset$5.params.edges, caustic = defaultPreset$5.params.caustic, effectScale, size = effectScale === void 0 ? defaultPreset$5.params.size : 10 / 9 / effectScale - 1 / 9, fit = defaultPreset$5.params.fit, scale = defaultPreset$5.params.scale, rotation = defaultPreset$5.params.rotation, originX = defaultPreset$5.params.originX, originY = defaultPreset$5.params.originY, offsetX = defaultPreset$5.params.offsetX, offsetY = defaultPreset$5.params.offsetY, worldWidth = defaultPreset$5.params.worldWidth, worldHeight = defaultPreset$5.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorHighlight: getShaderColorFromString(colorHighlight),
...
var ImageDithering = (0, import_react.memo)(function ImageDitheringImpl({ speed = defaultPreset$4.params.speed, frame = defaultPreset$4.params.frame, colorFront = defaultPreset$4.params.colorFront, colorBack = defaultPreset$4.params.colorBack, colorHighlight = defaultPreset$4.params.colorHighlight, image = "", type = defaultPreset$4.params.type, colorSteps = defaultPreset$4.params.colorSteps, originalColors = defaultPreset$4.params.originalColors, inverted = defaultPreset$4.params.inverted, pxSize, size = pxSize === void 0 ? defaultPreset$4.params.size : pxSize, fit = defaultPreset$4.params.fit, scale = defaultPreset$4.params.scale, rotation = defaultPreset$4.params.rotation, originX = defaultPreset$4.params.originX, originY = defaultPreset$4.params.originY, offsetX = defaultPreset$4.params.offsetX, offsetY = defaultPreset$4.params.offsetY, worldWidth = defaultPreset$4.params.worldWidth, worldHeight = defaultPreset$4.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorFront: getShaderColorFromString(colorFront),
		u_colorBack: getShaderColorFromString(colorBack),
...
var heatmapPresets = [defaultPreset$3, {
	name: "Sepia",
	params: {
		...defaultObjectSizing,
		scale: .75,
...
var Heatmap = (0, import_react.memo)(function HeatmapImpl({ speed = defaultPreset$3.params.speed, frame = defaultPreset$3.params.frame, image = "", contour = defaultPreset$3.params.contour, angle = defaultPreset$3.params.angle, noise = defaultPreset$3.params.noise, innerGlow = defaultPreset$3.params.innerGlow, outerGlow = defaultPreset$3.params.outerGlow, colorBack = defaultPreset$3.params.colorBack, colors = defaultPreset$3.params.colors, suspendWhenProcessingImage = false, fit = defaultPreset$3.params.fit, offsetX = defaultPreset$3.params.offsetX, offsetY = defaultPreset$3.params.offsetY, originX = defaultPreset$3.params.originX, originY = defaultPreset$3.params.originY, rotation = defaultPreset$3.params.rotation, scale = defaultPreset$3.params.scale, worldHeight = defaultPreset$3.params.worldHeight, worldWidth = defaultPreset$3.params.worldWidth, ...props }) {
...
var LiquidMetal = (0, import_react.memo)(function LiquidMetalImpl({ colorBack = defaultPreset$2.params.colorBack, colorTint = defaultPreset$2.params.colorTint, speed = defaultPreset$2.params.speed, frame = defaultPreset$2.params.frame, image = "", contour = defaultPreset$2.params.contour, distortion = defaultPreset$2.params.distortion, softness = defaultPreset$2.params.softness, repetition = defaultPreset$2.params.repetition, shiftRed = defaultPreset$2.params.shiftRed, shiftBlue = defaultPreset$2.params.shiftBlue, angle = defaultPreset$2.params.angle, shape = defaultPreset$2.params.shape, suspendWhenProcessingImage = false, fit = defaultPreset$2.params.fit, scale = defaultPreset$2.params.scale, rotation = defaultPreset$2.params.rotation, originX = defaultPreset$2.params.originX, originY = defaultPreset$2.params.originY, offsetX = defaultPreset$2.params.offsetX, offsetY = defaultPreset$2.params.offsetY, worldWidth = defaultPreset$2.params.worldWidth, worldHeight = defaultPreset$2.params.worldHeight, ...props }) {
	const imageUrl = typeof image === "string" ? image : image.src;
	const [processedStateImage, setProcessedStateImage] = (0, import_react.useState)(transparentPixel);
	let processedImage;
...
var HalftoneDots = (0, import_react.memo)(function HalftoneDotsImpl({ speed = defaultPreset$1.params.speed, frame = defaultPreset$1.params.frame, colorFront = defaultPreset$1.params.colorFront, colorBack = defaultPreset$1.params.colorBack, image = "", size = defaultPreset$1.params.size, radius = defaultPreset$1.params.radius, contrast = defaultPreset$1.params.contrast, originalColors = defaultPreset$1.params.originalColors, inverted = defaultPreset$1.params.inverted, grainMixer = defaultPreset$1.params.grainMixer, grainOverlay = defaultPreset$1.params.grainOverlay, grainSize = defaultPreset$1.params.grainSize, grid = defaultPreset$1.params.grid, type = defaultPreset$1.params.type, fit = defaultPreset$1.params.fit, scale = defaultPreset$1.params.scale, rotation = defaultPreset$1.params.rotation, originX = defaultPreset$1.params.originX, originY = defaultPreset$1.params.originY, offsetX = defaultPreset$1.params.offsetX, offsetY = defaultPreset$1.params.offsetY, worldWidth = defaultPreset$1.params.worldWidth, worldHeight = defaultPreset$1.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorFront: getShaderColorFromString(colorFront),
		u_colorBack: getShaderColorFromString(colorBack),
